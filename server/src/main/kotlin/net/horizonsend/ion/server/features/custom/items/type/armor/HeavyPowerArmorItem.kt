...
class HeavyPowerArmorItem(identifier: String, displayName: Component, itemModel: String, slot: EquipmentSlot, maxPrimaryMods: Int, maxSecondaryMods: Int, balancingSupplier: PVPBalancingConfiguration.Armour.AttributeHolder): PowerArmorItem(
